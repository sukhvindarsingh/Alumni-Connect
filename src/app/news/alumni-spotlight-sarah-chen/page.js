// src/app/news/alumni-spotlight-sarah-chen/page.jsx
"use client";
...
const postData = {
  ...
  subtitle: 'Meet Sarah Chen, Class of 2005, and her groundbreaking work in sustainable energy.',
  date: 'July 10, 2024',
  author: 'Alumni Association',
  content: `
    <p class="text-lg text-gray-700 leading-relaxed mb-6">We are proud to feature Sarah Chen, an exceptional alumna from the Class of 2005, who has been named "Innovator of the Year" by the National Energy Council. Sarah's work focuses on developing affordable and scalable sustainable energy solutions that are now being implemented in communities across the country.</p>
    <h2 class="text-3xl font-bold mt-10 mb-4 font-serif">A Vision for a Greener Future</h2>
    <p class="text-lg text-gray-700 leading-relaxed mb-6">From her time on campus, where she led the student environmental club, Sarah has been passionate about combining her engineering expertise with her commitment to environmental stewardship. Her current project involves a new type of solar panel that is not only more efficient but also uses recycled materials, significantly reducing its carbon footprint.</p>
    <blockquote class="text-xl italic text-gray-600 border-l-4 border-blue-500 pl-6 my-8">
      "The foundation I received at our university gave me the courage and the skills to tackle global challenges. It's a privilege to use my education to create a positive impact on the world."
    </blockquote>
    <p class="text-lg text-gray-700 leading-relaxed mt-6">Sarah’s journey is an inspiration to all of us. She proves that with dedication and a clear vision, our alumni can truly change the world. The Alumni Association is excited to see what she accomplishes next and encourages others to follow in her footsteps.</p>
  `,
  image: 'https://images.unsplash.com/photo-1620282158934-2e2a8626f281?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  relatedPosts: [
