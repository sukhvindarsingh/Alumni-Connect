// src/app/news/annual-gala/page.jsx
"use client";
...
const postData = {
  ...
  subtitle: 'Join us for a night of celebration, networking, and reminiscing on October 26th.',
  date: 'July 5, 2024',
  author: 'Alumni Association',
  content: `
    <p class="text-lg text-gray-700 leading-relaxed mb-6">Mark your calendars! Our annual Alumni Reunion Gala is officially scheduled for **Saturday, October 26, 2024**. This year's event will be held at the elegant Grand Ballroom downtown, promising an unforgettable evening of celebration, networking, and connection with fellow alumni from all generations.</p>
    <h2 class="text-3xl font-bold mt-10 mb-4 font-serif">Event Highlights</h2>
    <ul class="list-disc list-inside space-y-2 text-gray-700">
      <li>**Keynote Speaker:** A special address from a distinguished alumnus, to be announced soon!</li>
      <li>**Award Ceremony:** We will be honoring this year's most impactful alumni with the "Distinguished Alumni Awards."</li>
      <li>**Networking Reception:** A dedicated time to mix and mingle with old friends and new acquaintances over cocktails.</li>
      <li>**Live Entertainment:** Enjoy music and performances by alumni artists throughout the evening.</li>
    </ul>
    <h3 class="text-2xl font-bold mt-8 mb-4 font-serif">Registration Information</h3>
    <p class="text-lg text-gray-700 leading-relaxed mb-6">Early bird registration is now open for a limited time! We encourage you to register as soon as possible, as space is limited and this event fills up every year. Visit the link below to reserve your spot.</p>
    <div class="mt-8">
      <a href="../registration" class="inline-block bg-blue-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg hover:bg-blue-700 transition-colors duration-200 transform hover:scale-105">
        Register Now
      </a>
    </div>
  `,
  image: 'https://images.unsplash.com/photo-1541746972966-d4468f74a8c9?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  relatedPosts: [
