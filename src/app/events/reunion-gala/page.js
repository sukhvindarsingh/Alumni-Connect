// src/app/events/reunion-gala/page.js (for Next.js 13+ App Router)
// or pages/events/reunion-gala.js (for older Pages Router)
...
export default function ReunionGalaPage() {
    const event = {
        title: 'Alumni Reunion Gala',
        date: 'October 26, 2025',
        location: 'City Convention Center',
        longDescription: 'Join us for an unforgettable evening of dinner, dancing, and networking. This annual gala is the perfect opportunity to reconnect with old friends, make new connections, and celebrate the accomplishments of our community. The night will feature a keynote speaker, live music, and a silent auction to support our scholarship fund.',
                    ...
                    <div className="bg-white rounded-xl shadow-lg border border-neutral-200 overflow-hidden">
                        ...
                        <div className="p-8 md:p-12">
                            ...
                            {event.isPast ? (
                                ...
                                <motion.a
                                    // REPLACED THE '#' WITH A WORKING LINK
                                    href="/registration" 
