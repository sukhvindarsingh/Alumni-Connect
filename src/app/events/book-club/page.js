// src/app/events/book-club/page.js
...
export default function BookClubPage() {
    const event = {
        ...
        longDescription: 'Join our next virtual book club meeting to discuss the novel of the month, "The Midnight Library" by Matt Haig. We will delve into the themes, characters, and our personal takeaways from the story. This is a great way to engage with other alumni and share your love for literature. The meeting link will be sent to registered attendees one day prior to the event.',
        image: 'https://images.unsplash.com/photo-1589998059171-988d887df646?q=80&w=2670&auto=format&fit-crop',
        category: 'Social'
    };
