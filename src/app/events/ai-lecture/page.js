// src/app/events/ai-lecture/page.js
...
const BackIcon = () => (<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinecap="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" /></svg>);
...
export default function AILecturePage() {
    const event = {
        ...
        longDescription: 'Join us for a thought-provoking lecture by Dr. Evelyn Reed, a leading expert in artificial intelligence and machine learning. Dr. Reed will discuss the ethical implications of AI, its potential to revolutionize industries, and the skills needed to thrive in an AI-driven world. The session will conclude with an interactive Q&A.',
        image: 'https://images.unsplash.com/photo-1620712949543-f119e7a468d6?q=80&w=2670&auto=format&fit-crop',
        category: 'Lecture'
    };
