// src/app/events/workshops/career-networking/page.js
                ...
                >
                    ...
                    <div className="bg-white rounded-xl shadow-lg border border-neutral-200 overflow-hidden">
                        ...
                        <div className="p-8 md:p-12">
                            ...
                            >
                                <span className="flex items-center gap-2"><ClockIcon /> {workshop.date}</span>
                                <span className="flex items-center gap-2"><LocationIcon /> {workshop.location}</span>
                            </motion.div>
