// src/app/blog/lifelong-learning/page.jsx
"use client";
...
const postData = {
  ...
  content: `
    <p class="text-lg text-gray-700 leading-relaxed mb-6">Learning doesn’t stop after graduation. Professor David Kim discusses the importance of continuous learning and highlights the many resources available to alumni for professional development. This article serves as a guide to staying ahead in your career and pursuing your passions.</p>
    <h2 class="text-3xl text-gray-700 font-bold mt-10 mb-4 font-serif">Resources for Continuous Learning</h2>
    <ul class="list-disc list-inside space-y-2 text-gray-700">
      <li><strong>Online Courses:</strong> Platforms like Coursera and edX offer a wide range of subjects.</li>
      <li><strong>Alumni Workshops:</strong> Our alumni network frequently hosts skill-building workshops and seminars.</li>
      <li><strong>Mentorship Programs:</strong> Connect with experienced alumni who can guide your professional growth.</li>
    </ul>
    <p class="text-lg text-gray-700 leading-relaxed mt-6">By embracing a mindset of lifelong learning, you can unlock new opportunities and remain a valuable asset in a rapidly changing world.</p>
  `,
